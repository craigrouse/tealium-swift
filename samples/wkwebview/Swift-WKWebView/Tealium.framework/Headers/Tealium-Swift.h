...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Tealium",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


/// Coordinates optional modules with primary Tealium class.
SWIFT_CLASS("_TtC7Tealium21TealiumModulesManager")
...
SWIFT_CLASS("_TtC7Tealium21TealiumRemoteCommands")
...
SWIFT_CLASS("_TtC7Tealium29TealiumTagManagementUIWebView")
...
@interface TealiumTagManagementUIWebView (SWIFT_EXTENSION(Tealium)) <UIWebViewDelegate>
...
SWIFT_CLASS("_TtC7Tealium29TealiumTagManagementWKWebView") SWIFT_AVAILABILITY(ios,introduced=11.0)
...
@interface TealiumTagManagementWKWebView (SWIFT_EXTENSION(Tealium)) <WKHTTPCookieStoreObserver>
...
SWIFT_AVAILABILITY(ios,introduced=11.0)
@interface TealiumTagManagementWKWebView (SWIFT_EXTENSION(Tealium)) <WKNavigationDelegate>
/// Called when the WebView has finished loading a resource (DOM Complete)
...
SWIFT_CLASS("_TtC7Tealium19TealiumVolatileData")
